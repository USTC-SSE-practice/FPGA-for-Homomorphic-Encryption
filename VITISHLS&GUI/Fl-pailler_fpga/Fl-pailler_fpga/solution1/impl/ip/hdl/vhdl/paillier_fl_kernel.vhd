...
architecture behav of paillier_fl_kernel is 
    ...
    "paillier_fl_kernel_paillier_fl_kernel,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.110313,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=316,HLS_SYN_LUT=356,HLS_VERSION=2022_2}";
    ...
    signal icmp_ln178_fu_65_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln178_reg_76 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, icmp_ln178_fu_65_p2, ap_CS_fsm_state3, ap_CS_fsm_state4, regslice_both_data_out_U_apdone_blk, ap_block_state3_on_subcall_done)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if (((icmp_ln178_fu_65_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state3;
                elsif (((icmp_ln178_fu_65_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then
            ...
            when ap_ST_fsm_state4 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state4) and (regslice_both_data_out_U_apdone_blk = ap_const_logic_0))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state4;
                end if;
    ...
    ap_ST_fsm_state4_blk_assign_proc : process(regslice_both_data_out_U_apdone_blk)
    begin
    ...
    ap_block_state3_on_subcall_done_assign_proc : process(icmp_ln178_reg_76, grp_paillier_fl_kernel_Pipeline_VITIS_LOOP_178_1_fu_52_ap_done)
    begin
                ap_block_state3_on_subcall_done <= ((grp_paillier_fl_kernel_Pipeline_VITIS_LOOP_178_1_fu_52_ap_done = ap_const_logic_0) and (icmp_ln178_reg_76 = ap_const_lv1_1));
    end process;


    ap_done_assign_proc : process(ap_CS_fsm_state4, regslice_both_data_out_U_apdone_blk)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (regslice_both_data_out_U_apdone_blk = ap_const_logic_0))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state4, regslice_both_data_out_U_apdone_blk)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (regslice_both_data_out_U_apdone_blk = ap_const_logic_0))) then 
    ...
    data_in_TREADY_int_regslice_assign_proc : process(icmp_ln178_reg_76, grp_paillier_fl_kernel_Pipeline_VITIS_LOOP_178_1_fu_52_data_in_TREADY, ap_CS_fsm_state3)
    begin
        if (((icmp_ln178_reg_76 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    grp_paillier_fl_kernel_Pipeline_VITIS_LOOP_178_1_fu_52_data_out_TREADY <= (data_out_TREADY_int_regslice and ap_CS_fsm_state3);
    icmp_ln178_fu_65_p2 <= "1" when (signed(num_samples) > signed(ap_const_lv32_0)) else "0";
