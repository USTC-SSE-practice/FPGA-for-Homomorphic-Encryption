...
$(ObjDir)/paillier_hls_tb.cpp_pre.cpp.tb.o : paillier_hls_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling paillier_hls_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/paillier_hls.cpp_pre.cpp.tb.o : paillier_hls.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling paillier_hls.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
