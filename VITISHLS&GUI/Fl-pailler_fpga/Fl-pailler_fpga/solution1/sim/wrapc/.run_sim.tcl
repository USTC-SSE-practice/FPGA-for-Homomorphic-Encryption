...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "paillier_fl_kernel.autotvin.dat"
	set constFileTvOut       "paillier_fl_kernel.autotvout.dat"
	set constFileHdlTvIn     "paillier_fl_kernel.autohdltvin.dat"
	set constFileHdlTvOut    "paillier_fl_kernel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
