...
# 2 "<built-in>" 2
# 1 "src/paillier_hls.cpp" 2
# 1 "src/paillier_hls.h" 1
...
__attribute__((sdx_kernel("paillier_fl_kernel", 0))) void paillier_fl_kernel(hls::stream<axis_t> &data_in, hls::stream<axis_t> &grad_stream, hls::stream<axis_t> &data_out, int num_samples, int num_clients);
# 2 "src/paillier_hls.cpp" 2
# 1 "C:/Xilinx/Vitis_HLS/2022.2/common/technology/autopilot/ap_int.h" 1
# 3 "src/paillier_hls.cpp" 2
...
struct PaillierKeys {
    paillier_uint64_t n;
    paillier_uint64_t g;
    paillier_uint64_t lambda;
    paillier_uint64_t mu;
};
...
#pragma HLS INLINE
 paillier_uint64_t result = 0;
    VITIS_LOOP_18_1: for (int i = 0; i < 64; i++) {
...
paillier_uint64_t mod_exp(paillier_uint64_t base, paillier_uint64_t exp, paillier_uint64_t n) {
    ...
    base = base % n;
    VITIS_LOOP_34_1: for (int i = 0; i < 64; i++) {
#pragma HLS PIPELINE II=1
 if (exp & 1) {
...
#pragma HLS PIPELINE II=1
 paillier_uint64_t agg_grad = 0;
    VITIS_LOOP_152_1: for (int i = 0; i < num_clients; i++) {
...
__attribute__((sdx_kernel("paillier_fl_kernel", 0))) void paillier_fl_kernel(
...
#line 16 "F:/Fl-pailler_fpga/Fl-pailler_fpga/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=paillier_fl_kernel
# 169 "src/paillier_hls.cpp"

#line 6 "F:/Fl-pailler_fpga/Fl-pailler_fpga/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=paillier_fl_kernel
# 169 "src/paillier_hls.cpp"
...
#pragma HLS INTERFACE s_axilite port=return bundle=control
 ...
 VITIS_LOOP_178_1: for (int i = 0; i < num_samples; ++i) {
#pragma HLS PIPELINE II=1
