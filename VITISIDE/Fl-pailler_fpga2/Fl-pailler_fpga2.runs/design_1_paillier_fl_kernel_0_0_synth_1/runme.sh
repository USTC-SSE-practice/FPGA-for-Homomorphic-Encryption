...
HD_PWD='C:/Users/Administrator/VivadoProjects/Fl-pailler_fpga2/Fl-pailler_fpga2.runs/design_1_paillier_fl_kernel_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_paillier_fl_kernel_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_paillier_fl_kernel_0_0.tcl
