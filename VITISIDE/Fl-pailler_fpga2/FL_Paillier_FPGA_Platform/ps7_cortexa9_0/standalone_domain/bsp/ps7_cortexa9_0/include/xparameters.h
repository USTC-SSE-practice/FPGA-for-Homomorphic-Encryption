...
/* Definitions for driver PAILLIER_FL_KERNEL */
#define XPAR_XPAILLIER_FL_KERNEL_NUM_INSTANCES 1

/* Definitions for peripheral PAILLIER_FL_KERNEL_0 */
#define XPAR_PAILLIER_FL_KERNEL_0_DEVICE_ID 0
#define XPAR_PAILLIER_FL_KERNEL_0_S_AXI_CONTROL_BASEADDR 0x40010000
#define XPAR_PAILLIER_FL_KERNEL_0_S_AXI_CONTROL_HIGHADDR 0x4001FFFF


/******************************************************************/

/* Canonical definitions for peripheral PAILLIER_FL_KERNEL_0 */
#define XPAR_XPAILLIER_FL_KERNEL_0_DEVICE_ID XPAR_PAILLIER_FL_KERNEL_0_DEVICE_ID
#define XPAR_XPAILLIER_FL_KERNEL_0_S_AXI_CONTROL_BASEADDR 0x40010000
#define XPAR_XPAILLIER_FL_KERNEL_0_S_AXI_CONTROL_HIGHADDR 0x4001FFFF
